...
const advertisementsSeed = [
    ...
    },
    {
      ...
      description: "Ofrezco servicios de cuidado de mascotas a domicilio. ¡Tu peludo amigo estará en buenas manos!",
      ...
      description: "Ofrezco entrenamiento personalizado para ayudarte a alcanzar tus metas de salud y fitness.",
      ...
      description: "Traducción precisa de documentos técnicos en varios idiomas. Experiencia en jerga técnica.",
      salary: "Tarifa por palabra",
      localization: "Remoto",
      ...
      description: "Experto en estrategias de marketing digital para aumentar tu visibilidad en línea.",
      ...
      {
      title: "Chef",
      description: "Chef profesional con experiencia en cocina gourmet y platos exquisitos para eventos especiales.",
      salary: "Negociable",
      ...
      {
      title: "Albañil",
      description: "Servicios de albañilería para proyectos de construcción y reparación de edificios.",
      ...
      {
      title: "Carpintero",
      description: "Carpintero experto en la creación de muebles y trabajos de carpintería personalizados.",
      salary: "Precio por proyecto",
      ...
      {
      title: "Electricista",
      description: "Servicios eléctricos para instalaciones y reparaciones de sistemas eléctricos.",
      salary: "Precio por proyecto",
      ...
      {
      title: "Fontanero",
      description: "Fontanero profesional para instalación y reparación de sistemas de fontanería.",
      salary: "Precio por proyecto",
      ...
      {
      title: "Pintor",
      description: "Pintor experimentado para proyectos de pintura interior y exterior.",
      salary: "Precio por proyecto",
      ...
      {
      title: "Jardinero",
      description: "Jardinero con pasión por el paisajismo y el cuidado de jardines.",
      salary: "Precio por proyecto",
      ...
      {
      title: "Yesero",
      description: "Especialista en yeso para trabajos de acabado y reparación de interiores.",
      salary: "Precio por proyecto",
      ...
      {
      title: "Techador",
      description: "Servicios de techado para instalación y reparación de techos.",
      salary: "Precio por proyecto",
      ...
      {
      title: "Hormigonero",
      description: "Experto en trabajos de hormigón para proyectos de construcción.",
      salary: "Precio por proyecto",
